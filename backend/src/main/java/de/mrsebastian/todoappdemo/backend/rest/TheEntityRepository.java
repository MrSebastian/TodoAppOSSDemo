 ...
 */
package de.mrsebastian.todoappdemo.backend.rest;
...
@PreAuthorize("hasAuthority(T(de.mrsebastian.todoappdemo.backend.security.AuthoritiesEnum).BACKEND_READ_THEENTITY.name())")
public interface TheEntityRepository extends CrudRepository<TheEntity, UUID> { //NOSONAR
    ...
    @PreAuthorize("hasAuthority(T(de.mrsebastian.todoappdemo.backend.security.AuthoritiesEnum).BACKEND_WRITE_THEENTITY.name())")
    ...
    @PreAuthorize("hasAuthority(T(de.mrsebastian.todoappdemo.backend.security.AuthoritiesEnum).BACKEND_DELETE_THEENTITY.name())")
